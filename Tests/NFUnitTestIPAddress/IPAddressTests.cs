...
namespace NFUnitTestIPAddress
{
    ...
    public class IPAddressTests
    {
        ...
        public void NetTest1_DNS()
        {
            ...
            Assert.Equal(ipHostEntry.AddressList.Length, 1, "GetHostEntry resturned wrong number of addresses");
        ...
        public void NetTest2_IPAddressBasic()
        {
            ...
            for (int i = 0; i <= 30; i++)
            {
                ...
                Debug.WriteLine("Random IP " + IPInts[0] + "." + IPInts[1]
                    + "." + IPInts[2] + "." + IPInts[3]);
        ...
        public void NetTest5_IPHostEntryBasic()
        {
            ...
            Assert.Trows(typeof(IndexOutOfRangeException), () => { ipHostEntry.AddressList[1].ToString(); });
        }
        ...
        public void NetTest6_SocketAddressBasic()
        {
            ...
            for (int i = 0; i <= 30; i++)
            {
                ...
                Assert.NotEqual(socketAddress1.ToString(), socketAddress2.ToString(), "ToString returns same for different data");
            }
